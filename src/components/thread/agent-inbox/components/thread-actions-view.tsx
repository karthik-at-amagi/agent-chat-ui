            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  status === "approve" &&
                    "border-emerald-500 bg-emerald-200 dark:bg-emerald-900/30",
                  status === "reject" &&
                    "border-red-500 bg-red-200 dark:bg-red-900/30",
                  status === "edit" &&
                    "border-amber-500 bg-amber-200 dark:bg-amber-900/30",
                  index === currentIndex &&
